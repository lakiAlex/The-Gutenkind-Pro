	...
	<div class="post-content">
		<?php
			...
			if (in_array(true, $more)) { ?>
				<div class="post-more-wrap"><a class="post-more <?php if (in_array('btn', $more_style)) : ?>button<?php else : ?>link<?php endif; ?>" href="<?php echo esc_url(get_permalink()); ?>"><?php echo esc_html($more_text); ?></a></div><?php
			}
		?>
	</div>
