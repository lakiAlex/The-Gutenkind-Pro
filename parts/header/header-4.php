...
<?php if ($show_logo == true) { ?>
	<a class="header__logo header--style-4 header__logo--big" href="<?php echo esc_url(home_url('/')); ?>">
...
<header class="header header--style-4">
	...
	<div class="header__top container">
		...
		<?php if ($header_social == true && function_exists('gutenkind_social_media')) gutenkind_social_media(); ?>
